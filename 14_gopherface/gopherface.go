...
import (
	...
	"github.com/QO-Development/udemyTraining/14_gopherface/handlers"
	//This alias's gorilla handlers to ghandlers
...
func main() {
	...
	//Put method is used for updates, post is used for new records
